...
public:
    DeformableInfantryOmniC()
        ...
        register_output("/gimbal/sample_time_s", sample_time_s_, 0.0);
        // register_output(
    ...
    void update() override {
        // Host update time, not the acquisition timestamp of individual CAN/IMU samples.
        *sample_time_s_ = std::chrono::duration<double>(Clock::now() - sample_time_origin_).count();
...
private:
    ...
    public:
        ...
        void can_receive_callback(const Spec::Can& can, const View::Can& data) override {
            ...
            // Only pitch feedback is used on the top board.
            }
        }
    ...
    OutputInterface<rmcs_description::Tf> tf_;
    OutputInterface<double> sample_time_s_;
    const Clock::time_point sample_time_origin_ = Clock::now();
